    ...
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased transition-transform duration-200 xl:left-0 -translate-x-full xl:translate-x-0 xl:bg-transparent">
      ...
      <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full">
        ...
        <li class="mt-0.5 w-full animate__animated animate__fadeIn">
          ...
          <li class="mt-0.5 w-full animate__animated animate__fadeIn">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="{{ route('guest-list') }}">
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
          ...
          <li class="w-full mt-4 animate__animated animate__fadeIn">
            <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase opacity-60">Halaman Akun</h6>
          </li>

          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm shadow-soft-xl ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" href="{{route('admin.edit')}}">
        ...
        <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
          <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
              ...
              <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">Profile</li>
            </ol>
            <h6 class="mb-0 font-bold capitalize">Pengaturan Akun</h6>
          </nav>
